  ...
  return (
    ...
    >
      <aside className="md:h-none h-screen md:static absolute inset-0">
        ...
        <ul
          className={`z-20 duration-500 transion-right md:transition-none bg-white md:bg-transparent md:block p-5 md:p-0 md:mx-5 md:my-0 absolute top-10 bottom-0 w-1/2 md:w-auto md:static md:right-auto ${menuShown ? 'right-0' : '-right-full'}`}
        >
          <li>
